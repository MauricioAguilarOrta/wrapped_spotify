...
# Es muy importante tener cuenta de Shiny y que ejecutes el siguiente código (tiene que estar separado el código que crea al tablero y el que crea al shiny)
